...
_0x0:
	...
	.DB  0x67,0x68,0x69,0x0,0x39,0x37,0x35,0x32
	.DB  0x31,0x33,0x37,0x38,0x0
_0x20C0060:
	.DB  0x1
_0x20C0000:
...
; 0000 000E 
; 0000 000F 	// Init
; 0000 0010 	GLCDINIT_t glcd_init_data;
...
;	glcd_init_data -> Y+0
	...
	ST   Y,R30
	STD  Y+1,R31
; 0000 0012 	glcd_init(&glcd_init_data);
	MOVW R26,R28
	RCALL _glcd_init
...
; 0000 0014     delay_ms(50);
	CALL SUBOPT_0x0
; 0000 0015 
; 0000 0016     // Name and student ID
; 0000 0017     glcd_outtextxy(0, 0, "Ali Sedaghi");
	LDI  R30,LOW(0)
	ST   -Y,R30
	ST   -Y,R30
	__POINTW2MN _0x3,0
	CALL _glcd_outtextxy
; 0000 0018     glcd_outtextxy(0, 53, "97521378");
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R30,LOW(53)
	ST   -Y,R30
...
; 0000 001B 
; 0000 001C     // House
; 0000 001D     glcd_line(55, 63, 91, 63);
	LDI  R30,LOW(55)
	ST   -Y,R30
	LDI  R30,LOW(63)
	ST   -Y,R30
	...
	LDI  R26,LOW(63)
	CALL _glcd_line
; 0000 001E     glcd_line(91, 63, 91, 32);
	LDI  R30,LOW(91)
	ST   -Y,R30
	LDI  R30,LOW(63)
	CALL SUBOPT_0x2
; 0000 001F     glcd_line(55, 63, 55, 32);
	LDI  R30,LOW(55)
	ST   -Y,R30
	LDI  R30,LOW(63)
	ST   -Y,R30
	LDI  R30,LOW(55)
	CALL SUBOPT_0x3
; 0000 0020     glcd_line(55, 32, 45, 32);
	LDI  R30,LOW(55)
	ST   -Y,R30
	LDI  R30,LOW(32)
	ST   -Y,R30
	LDI  R30,LOW(45)
	CALL SUBOPT_0x3
; 0000 0021     glcd_line(101, 32, 91, 32);
	LDI  R30,LOW(101)
	ST   -Y,R30
	LDI  R30,LOW(32)
	CALL SUBOPT_0x2
; 0000 0022     glcd_line(73, 0, 101, 32);
	LDI  R30,LOW(73)
	ST   -Y,R30
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R30,LOW(101)
	CALL SUBOPT_0x3
; 0000 0023     glcd_line(73, 0, 59, 14);
	LDI  R30,LOW(73)
	ST   -Y,R30
	LDI  R30,LOW(0)
	ST   -Y,R30
	...
	LDI  R26,LOW(14)
	CALL _glcd_line
; 0000 0024     glcd_line(52, 22, 45, 32);
	LDI  R30,LOW(52)
	ST   -Y,R30
	LDI  R30,LOW(22)
	ST   -Y,R30
	LDI  R30,LOW(45)
	CALL SUBOPT_0x3
; 0000 0025     glcd_line(52, 22, 52, 7);
	LDI  R30,LOW(52)
	ST   -Y,R30
	LDI  R30,LOW(22)
	ST   -Y,R30
	LDI  R30,LOW(52)
	CALL SUBOPT_0x4
; 0000 0026     glcd_line(59, 14, 59, 7);
	LDI  R30,LOW(14)
	ST   -Y,R30
	LDI  R30,LOW(59)
	CALL SUBOPT_0x4
; 0000 0027     glcd_line(59, 7, 62, 7);
	LDI  R30,LOW(7)
	ST   -Y,R30
	LDI  R30,LOW(62)
	ST   -Y,R30
...
; 0000 0028     glcd_line(52, 7, 49, 7);
	...
	LDI  R26,LOW(7)
	CALL _glcd_line
; 0000 0029     glcd_line(62, 7, 62, 3);
	LDI  R30,LOW(62)
	ST   -Y,R30
	LDI  R30,LOW(7)
	CALL SUBOPT_0x5
; 0000 002A     glcd_line(49, 7, 49, 3);
	LDI  R30,LOW(49)
	ST   -Y,R30
	LDI  R30,LOW(7)
	ST   -Y,R30
	...
	LDI  R26,LOW(3)
	CALL _glcd_line
; 0000 002B     glcd_line(49, 3, 62, 3);
	LDI  R30,LOW(49)
	ST   -Y,R30
	LDI  R30,LOW(3)
	CALL SUBOPT_0x5
; 0000 002C     delay_ms(2000);
	CALL SUBOPT_0x1
; 0000 002D     glcd_clear();
; 0000 002E 
; 0000 002F     while (1) {
_0x4:
; 0000 0030         glcd_setcolor(0);
	LDI  R30,LOW(0)
	CALL SUBOPT_0x6
; 0000 0031         glcd_circle(cx, cy, 4);
; 0000 0032 
; 0000 0033         if (dir == 0) {
	MOV  R0,R20
	OR   R0,R21
...
; 0000 003F             cx = cx + r;
	CALL SUBOPT_0x7
; 0000 0040             if (cx + r >= 127) {
	BRLT _0xC
; 0000 0041                 dir = 2;
	__GETWRN 20,21,2
; 0000 0042             }
; 0000 0043             if(cy + r >= 63) {
_0xC:
	LDD  R26,Y+6
	LDD  R27,Y+6+1
	ADD  R26,R18
...
_0xA:
; 0000 005B 
; 0000 005C         glcd_setcolor(1);
	LDI  R30,LOW(1)
	CALL SUBOPT_0x6
; 0000 005D         glcd_circle(cx, cy, 4);
